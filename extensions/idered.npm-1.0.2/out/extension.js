...
const inversify_1 = __webpack_require__(2674);
...
const inversify_1 = __webpack_require__(2674);
let VSCodeContext = class VSCodeContext {
};
VSCodeContext = __decorate([
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VSCodeWebView = void 0;
const inversify_1 = __webpack_require__(2674);
let VSCodeWebView = class VSCodeWebView {
};
VSCodeWebView = __decorate([
    (0, inversify_1.injectable)()
], VSCodeWebView);
exports.VSCodeWebView = VSCodeWebView;
//# sourceMappingURL=VSCodeWebView.js.map
...
const Bus_1 = __webpack_require__(6100);
const Router_1 = __webpack_require__(4749);
const WebviewProvider_1 = __webpack_require__(6804);
const App_1 = __webpack_require__(2849);
const VSCodeContext_1 = __webpack_require__(1914);
const VSCodeWebView_1 = __webpack_require__(8497);
function bootstrap(props) {
    const { routes, context, viewId } = props;
    App_1.default.bind("app").toConstantValue(App_1.default);
    App_1.default.bind(VSCodeContext_1.VSCodeContext).toConstantValue(context);
    App_1.default.bind(Bus_1.Bus).toConstantValue(new Bus_1.Bus());
    App_1.default.bind(Router_1.Router).toSelf().inSingletonScope();
    App_1.default.bind(WebviewProvider_1.WebviewProvider).toSelf().inSingletonScope();
    // Watch for webview registration event
    App_1.default
        .get(Bus_1.Bus)
        .on(WebviewProvider_1.WebviewProviderEvents.registered, (webviewView) => {
        // Attach router to webview
        App_1.default.get(Router_1.Router).registerWebview(webviewView);
        App_1.default.bind(VSCodeWebView_1.VSCodeWebView).toConstantValue(webviewView.webview);
        routes(App_1.default.get(Router_1.Router));
    });
    // Init webview loading
    const ids = Array.isArray(viewId) ? viewId : [viewId];
    ids.forEach((id) => {
        const webviewSub = vscode.window.registerWebviewViewProvider(id, App_1.default.get(WebviewProvider_1.WebviewProvider), {
            webviewOptions: {
...
const inversify_1 = __webpack_require__(2674);
let Bus = class Bus extends EventEmitter {
};
Bus = __decorate([
    (0, inversify_1.injectable)()
], Bus);
...
const RouteParser_1 = __webpack_require__(4905);
class Route {
    constructor(args) {
        this.uri = args.uri;
    ...
    get routeParser() {
        return new RouteParser_1.RouteParser(this.uri);
    }
    match(request) {
    ...
    getParameters(request) {
        return Object.assign({}, this.routeParser.getParams(request.uri)) || {};
    }
}
exports.Route = Route;
...
class RouteParser {
    ...
    getParams(url) {
        var _a;
        return (_a = this.regexp.exec(url)) === null || _a === void 0 ? void 0 : _a.groups;
    }
    match(url) {
...
const inversify_1 = __webpack_require__(2674);
const Route_1 = __webpack_require__(3033);
const VSCodeContext_1 = __webpack_require__(1914);
const inversify_props_1 = __webpack_require__(7629);
let Router = class Router {
    ...
    createRoute(methods, uri, [controller, action]) {
        const methodsArray = Array.isArray(methods) ? methods : [methods];
        return new Route_1.Route({ uri, methods: methodsArray, action, controller });
    }
    registerWebview(webviewView) {
        webviewView.webview.onDidReceiveMessage((event) => this.handle(event, webviewView), undefined, this.context.subscriptions);
    }
    findRoute(request) {
        return this.routes.find((item) => item.match(request));
    }
    handle(request, webviewView) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield controller[route.action](request.payload);
            if (result !== undefined) {
    ...
    provideParams(route, request) {
        const params = route.getParameters(request);
        const paramsArr = Object.values(params);
        if (inversify_props_1.container.isBound("Params")) {
            inversify_props_1.container.unbind("Params");
        }
        inversify_props_1.container.addRequest(function () {
            return params;
        }, "Params");
        return paramsArr;
    }
...
Router = __decorate([
    (0, inversify_1.injectable)(),
    __param(1, (0, inversify_1.inject)("app")),
    __metadata("design:paramtypes", [VSCodeContext_1.VSCodeContext,
...
function useInject(id) {
    return [(0, inversify_props_1.getContainer)().get(id)];
}
function useParams(cast) {
    return __awaiter(this, void 0, void 0, function* () {
        const params = useInject("Params")[0];
        const result = {};
        for (const paramName in cast) {
            const transform = cast[paramName];
...
class ContentProvider {
    getDevServerContent(context, webviewView) {
        return `<!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    getProductionContent(context, webviewView) {
        const uiPath = (0, path_1.join)(context.extensionPath, "out", "ui");
        const manifestPath = (0, path_1.join)(uiPath, "manifest.json");
        const manifestContent = (0, fs_1.readFileSync)(manifestPath);
        const manifest = JSON.parse(manifestContent.toString());
        const indexJS = vscode.Uri.file((0, path_1.join)(context.extensionPath, "out", "ui", manifest["index.html"].file));
        const indexCSS = vscode.Uri.file((0, path_1.join)(context.extensionPath, "out", "ui", manifest["index.html"].css[0]));
        const [vendorName] = manifest["index.html"].imports;
        const vendorJS = vscode.Uri.file((0, path_1.join)(context.extensionPath, "out", "ui", manifest[vendorName].file));
    ...
    getContent(context, webviewView) {
        if (true) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WebviewProvider = exports.WebviewProviderEvents = void 0;
const ContentProvider_1 = __webpack_require__(3949);
const inversify_1 = __webpack_require__(2674);
const Bus_1 = __webpack_require__(6100);
const VSCodeContext_1 = __webpack_require__(1914);
var WebviewProviderEvents;
(function (WebviewProviderEvents) {
    WebviewProviderEvents["registered"] = "WEBVIEW_PROVIDER_registered";
})(WebviewProviderEvents = exports.WebviewProviderEvents || (exports.WebviewProviderEvents = {}));
let WebviewProvider = class WebviewProvider {
    ...
    resolveWebviewView(webviewView, context, _token) {
        ...
        webviewView.webview.html = contentProvider.getContent(this.context, webviewView);
        this.bus.emit(WebviewProviderEvents.registered, webviewView);
    }
};
WebviewProvider = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(VSCodeContext_1.VSCodeContext)),
    __param(1, (0, inversify_1.inject)(Bus_1.Bus)),
    __metadata("design:paramtypes", [VSCodeContext_1.VSCodeContext,
        Bus_1.Bus])
], WebviewProvider);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.useParams = exports.Container = exports.inject = exports.injectable = exports.VSCodeWebView = exports.VSCodeContext = void 0;
const inversify_1 = __webpack_require__(2674);
...
var VSCodeContext_1 = __webpack_require__(1914);
Object.defineProperty(exports, "VSCodeContext", ({ enumerable: true, get: function () { return VSCodeContext_1.VSCodeContext; } }));
var VSCodeWebView_1 = __webpack_require__(8497);
Object.defineProperty(exports, "VSCodeWebView", ({ enumerable: true, get: function () { return VSCodeWebView_1.VSCodeWebView; } }));
var use_params_1 = __webpack_require__(8230);
Object.defineProperty(exports, "useParams", ({ enumerable: true, get: function () { return use_params_1.useParams; } }));
...
const parse = __webpack_require__(9015);
const enoent = __webpack_require__(5350);
...
const resolveCommand = __webpack_require__(5358);
const escape = __webpack_require__(6214);
const readShebang = __webpack_require__(3106);
...
const shebangCommand = __webpack_require__(4256);
...
const path = __webpack_require__(1017);
const which = __webpack_require__(9056);
const getPathKey = __webpack_require__(6569);
...
var container_1 = __webpack_require__(1015);
var id_helper_1 = __webpack_require__(9041);
...
__exportStar(__webpack_require__(9041), exports);
...
var inversify_1 = __webpack_require__(2674);
var id_helper_1 = __webpack_require__(9041);
var inject_helper_1 = __webpack_require__(6672);
...
var container_1 = __webpack_require__(1015);
var id_helper_1 = __webpack_require__(9041);
var log_helper_1 = __webpack_require__(4184);
var parameters_helper_1 = __webpack_require__(3270);
function injectable() {
...
var ERROR_MSGS = __webpack_require__(5640);
var METADATA_KEY = __webpack_require__(7425);
...
var error_msgs_1 = __webpack_require__(5640);
var METADATA_KEY = __webpack_require__(7425);
var metadata_1 = __webpack_require__(7258);
var decorator_utils_1 = __webpack_require__(8041);
...
var ERRORS_MSGS = __webpack_require__(5640);
var METADATA_KEY = __webpack_require__(7425);
function injectable() {
...
var literal_types_1 = __webpack_require__(5493);
var id_1 = __webpack_require__(2632);
...
var literal_types_1 = __webpack_require__(5493);
var METADATA_KEY = __webpack_require__(7425);
var metadata_reader_1 = __webpack_require__(1499);
var planner_1 = __webpack_require__(5262);
var resolver_1 = __webpack_require__(5933);
var binding_to_syntax_1 = __webpack_require__(9825);
var id_1 = __webpack_require__(2632);
var serialization_1 = __webpack_require__(8530);
var container_snapshot_1 = __webpack_require__(5817);
var lookup_1 = __webpack_require__(2240);
...
var container_1 = __webpack_require__(9700);
...
var container_module_1 = __webpack_require__(1164);
...
var constraint_helpers_1 = __webpack_require__(1146);
...
var binding_utils_1 = __webpack_require__(4577);
...
var binding_count_1 = __webpack_require__(7197);
var ERROR_MSGS = __webpack_require__(5640);
var literal_types_1 = __webpack_require__(5493);
var METADATA_KEY = __webpack_require__(7425);
var exceptions_1 = __webpack_require__(9523);
var serialization_1 = __webpack_require__(8530);
var context_1 = __webpack_require__(1734);
var metadata_1 = __webpack_require__(7258);
var plan_1 = __webpack_require__(4595);
var reflection_utils_1 = __webpack_require__(4912);
var request_1 = __webpack_require__(2929);
var target_1 = __webpack_require__(3927);
...
var id_1 = __webpack_require__(2632);
var metadata_1 = __webpack_require__(7258);
var queryable_string_1 = __webpack_require__(1625);
var Target = (function () {
...
var exceptions_1 = __webpack_require__(9523);
var serialization_1 = __webpack_require__(8530);
var instantiation_1 = __webpack_require__(198);
...
var literal_types_1 = __webpack_require__(5493);
var binding_when_on_syntax_1 = __webpack_require__(5714);
...
var binding_in_syntax_1 = __webpack_require__(1580);
var binding_on_syntax_1 = __webpack_require__(1003);
var binding_when_syntax_1 = __webpack_require__(7190);
...
var ERROR_MSGS = __webpack_require__(5640);
var literal_types_1 = __webpack_require__(5493);
var binding_in_when_on_syntax_1 = __webpack_require__(1142);
var binding_when_on_syntax_1 = __webpack_require__(5714);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __webpack_require__(837)
} else {
  core = __webpack_require__(4703)
}
...
const shebangRegex = __webpack_require__(3882);
...
const foundation_1 = __webpack_require__(3727);
...
const NpmClient_1 = __webpack_require__(9086);
const PnpmClient_1 = __webpack_require__(1402);
const YarnClient_1 = __webpack_require__(1439);
...
const fs = __webpack_require__(7147);
const spawn = __webpack_require__(8995);
const path_1 = __webpack_require__(1017);
const Client_1 = __webpack_require__(2585);
const foundation_1 = __webpack_require__(3727);
...
const WebviewProvider_1 = __webpack_require__(6804);
const Bus_1 = __webpack_require__(6100);
let AddDependencyCommand = class AddDependencyCommand {
    constructor(context, bus, container) {
        this.context = context;
        this.bus = bus;
        this.container = container;
        this.context.subscriptions.push(this.command());
        this.bus.on(WebviewProvider_1.WebviewProviderEvents.registered, (webview) => {
            if (!this.focusOnWebviewRegister)
                return;
            webview.webview.onDidReceiveMessage((message) => {
                if ((message === null || message === void 0 ? void 0 : message.type) !== "AUTOCOMPLETE_INPUT_MOUNTED")
                    return;
    ...
    focusInput() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.container.isBound(foundation_1.VSCodeWebView)) {
                const webviewView = this.container.get(foundation_1.VSCodeWebView);
                yield webviewView.postMessage({ type: "FOCUS_INPUT" });
            }
            else {
    ...
    command() {
        return vscode.commands.registerCommand("iridium.npm.addDependency", () => __awaiter(this, void 0, void 0, function* () {
            yield vscode.commands.executeCommand("workbench.view.extension.iridium");
            yield this.focusInput();
        }));
    }
};
AddDependencyCommand = __decorate([
    (0, foundation_1.injectable)(),
    __param(0, (0, foundation_1.inject)(foundation_1.VSCodeContext)),
    __param(1, (0, foundation_1.inject)(Bus_1.Bus)),
    __param(2, (0, foundation_1.inject)("app")),
    __metadata("design:paramtypes", [Object, Bus_1.Bus,
        foundation_1.Container])
...
const Controller_1 = __webpack_require__(4274);
const vscode_1 = __webpack_require__(9496);
...
const vscode_1 = __webpack_require__(9496);
const foundation_1 = __webpack_require__(3727);
const ClientManager_1 = __webpack_require__(4911);
const path_1 = __webpack_require__(1017);
const fs = __webpack_require__(7147);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const PackageJsonController_1 = __webpack_require__(8054);
const ConfigController_1 = __webpack_require__(2216);
...
const isexe = __webpack_require__(5909)
...
const vscode = __webpack_require__(9496);
const bootstrap_1 = __webpack_require__(6215);
const routes_1 = __webpack_require__(8314);
const Bus_1 = __webpack_require__(6100);
const WebviewProvider_1 = __webpack_require__(6804);
const ClientManager_1 = __webpack_require__(4911);
const NpmClient_1 = __webpack_require__(9086);
const YarnClient_1 = __webpack_require__(1439);
const PnpmClient_1 = __webpack_require__(1402);
const AddDependencyCommand_1 = __webpack_require__(7055);
function activate(context) {
    const app = (0, bootstrap_1.bootstrap)({
        context,
        routes: routes_1.default,
        viewId: "iridium.npm",
    });
    app.bind(NpmClient_1.NpmClient).toSelf();
    app.bind(YarnClient_1.YarnClient).toSelf();
    app.bind(PnpmClient_1.PnpmClient).toSelf();
    app.bind(ClientManager_1.ClientManager).toSelf();
    app.bind(AddDependencyCommand_1.AddDependencyCommand).toSelf();
    app.resolve(AddDependencyCommand_1.AddDependencyCommand);
    app
        .get(Bus_1.Bus)
        .on(WebviewProvider_1.WebviewProviderEvents.registered, (webviewView) => {
        if (vscode.workspace.workspaceFolders) {
            const watcher = vscode.workspace.createFileSystemWatcher("**/package.json");
            const notify = () => webviewView.webview.postMessage({ type: "PACKAGE_JSON_UPDATED" });
