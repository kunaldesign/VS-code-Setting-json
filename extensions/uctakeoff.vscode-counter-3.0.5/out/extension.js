...
const append = (langs, id, value) => {
    ...
    (_a = value.aliases) === null || _a === void 0 ? void 0 : _a.forEach(v => langExt.aliases.push(v));
    (_b = value.filenames) === null || _b === void 0 ? void 0 : _b.forEach(v => langExt.filenames.push(v));
    (_c = value.extensions) === null || _c === void 0 ? void 0 : _c.forEach(v => langExt.extensions.push(v));
    (_d = value.lineComments) === null || _d === void 0 ? void 0 : _d.forEach(v => langExt.lineComments.push(v));
    (_e = value.blockComments) === null || _e === void 0 ? void 0 : _e.forEach(v => langExt.blockComments.push(v));
    (_f = value.blockStrings) === null || _f === void 0 ? void 0 : _f.forEach(v => langExt.blockStrings.push(v));
    return langExt;
};
...
const outputResults = async (date, targetDirUri, results, outputDir, prevOutputDir, conf) => {
    ...
    if (conf.outputAsMarkdown) {
        ...
        await Promise.all(mds.map(({ title, path, table, detail }, index) => {
            return (0, vscode_utils_1.writeTextFile)(outputDir, path, table.toMarkdown(date, title, detail, mds.map((f, i) => [f.title, i === index ? undefined : f.path])));
        }));
    }
